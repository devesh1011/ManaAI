...
async def register_user(
    response: Response, user_data: user_schema.UserCreate, db: Session = Depends(get_db)
):
    """
...
@api_router.post("/login", response_model=auth_schema.APIResponseStatus)
...
@api_router.post(
    "/admin/login-as/{user_id}", response_model=auth_schema.APIResponseStatus
)
async def login_as(
    user_id: str,
    response: Response,
...
@api_router.post("/logout", response_model=auth_schema.APIResponseStatus)
...
@api_router.post("/refresh", response_model=auth_schema.APIResponseStatus)
